"""Tests for the Requirement Analysis service layer.
...
class TestAnalyze:
    ...
    async def test_analyze_success(self, mock_provider, mock_registry, mock_prompt_manager):
        ...
        request = AnalysisRequest(
            content="The system shall allow users to log in with email and password.",
...
class TestGetSession:
    """Tests for RequirementAnalysisService.get_session()."""
    ...
    async def test_get_existing_session(self, mock_provider, mock_registry, mock_prompt_manager):
        ...
        # Manually set the session on the repo mock
        # Actually the repo is set within __init__, let's just assign
        service._repository = fake_repo
...
class TestListSessions:
    """Tests for RequirementAnalysisService.list_sessions()."""
